...
<head>
    ...
    <title>SportShop PRO - Главная</title>
...
<section class="hero">
    <h1>Товары для спорта и фитнеса<br>Достигай новых вершин</h1>
    <button class="btn" onclick="location.href='catalog.php';">Купить сейчас</button>
</section>
...
<section class="section">
    ...
    <div class="products">
        <?php
        $result = $db->query("SELECT * FROM products ORDER BY created_at DESC LIMIT 4");
